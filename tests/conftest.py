...
def eur_transactions():
    return [
        {'id': 939719777, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572', 'operationAmount':
        {'amount': '9824.07', 'currency': {'name': 'EUR', 'code': 'EUR'}},
...
def cny_transactions():
    return [
        {'id': 763226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689',
         'operationAmount': {'amount': '67314.70', 'currency': {'name': 'юа́нь', 'code': 'CNY'}},
         'description': 'Перевод с карты на карту', 'from': 'Visa Platinum 1246377376343588',
         'to': 'Счет 14211924144426031657'},
    ]
