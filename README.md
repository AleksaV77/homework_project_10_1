...
```
```
- Функция, возвращает список словарей с данными о финансовых 
транзакциях из файла csv
```
```
- Функция, возвращает список словарей с данными о финансовых 
транзакциях из файла excel
```
```
...
```
```
Тестирование функции, которая принимает на вход путь до JSON-файла 
...
```
```
Тестирование функции, которая принимает на вход путь до csv-файла 
и возвращает список словарей с данными о финансовых транзакциях
```
```
Тестирование функции, которая принимает на вход путь до excel-файла 
и возвращает список словарей с данными о финансовых транзакциях
```
```
Тестирование функции, которая принимает список словарей и фильтрует по определенное слово в описании
```
```
Тестирование функции, подсчета количества операций в каждой категории
```
```
